...
import PvpRankByMap from '@/components/PvpRankByMap.vue'
import PvpRankByLadders from '@/components/PvpRankByLadders.vue'

export default {
  name: 'PvpRankView',
  components: { PvpRank, PvpRankByAccount, PvpRankByMap,PvpRankByProfessions, PvpRankByLadders },
  setup() {
    const test = 2
    return { test }
  },
